"""
This third sniffer will capture TCP packets in the network
"""
import scapy.all as scapy

def get_tcp_packages(prn: callable = lambda x: x.show(), count: int = 1, filter: str = "tcp", iface: str = scapy.conf.iface):
    """
